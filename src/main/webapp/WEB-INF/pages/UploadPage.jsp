	...
	<div class="navbar navbar-default navbar-fixed-top">
		<div class="container">
            ...
            <ul class="nav navbar-nav">
                <li><a href="<c:url value="/main" />"><strong><%=user%></strong></a></li>  
	...
	<div class="container">
		...
		<form id="fileupload" action="<c:url value="/upload" />" method="POST"
            ...
            <div style="color: #222; padding: 10px;">
				<table>
					<tr>
						<td><input type="radio" onclick="javascript:clearOtherFields()" name="modifier" value="2" id="radio2"
							class="css-checkbox" checked="checked" /><label for="radio2"
							class="css-label radGroup2">Private.</label></td>
						<td><input type="radio" onclick="javascript:clearOtherFields()" name="modifier" value="3" id="radio3"
							class="css-checkbox" /><label for="radio3"
							class="css-label radGroup2">Share with:</label></td>
							<td><input id="tags" onclick = "javascript:Clear();" value="enter user name here..." onkeyup="doAjax(this.value)" name = "nickName" style="width: 300px;"></td>
</tr>
				</table>
			</div>
