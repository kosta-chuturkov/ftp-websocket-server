 ...
 */
@Service
public class SharedFilesHandler implements JsonTypedHandler {
    ...
    public JsonResponse getJsonResponse(final JsonRequest jsonRequest) {
        ...
        final List<File> files = this.fileService.getSharedFilesForUser(User.getCurrent().getNickName(), firstResult.getAsInt(), maxResults.getAsInt());
