...
public class PageNavigationController {
    ...
    private ResponseEntity<?> register(@NotNull @ModelAttribute("email") String email, @NotNull @ModelAttribute("pswd") String password, @NotNull @ModelAttribute("nickname") String nickName, @NotNull @ModelAttribute("password_repeated") String password_repeated) {
        if (User.isAuthenticated()) {
